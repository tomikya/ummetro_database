...
if (isset($_POST['tanggal_berita'])) {
    ...
    $shrt_desk = $_POST['short_desk'];
    $desk = $_POST['deskripsi_berita'];
    $image = $_FILES['gambar_berita'];

    $query = mysqli_query($konek, "UPDATE berita SET tanggal_berita = '$tnggl',short_desk='$shrt_desk', deskripsi_berita='$desk' WHERE id_berita=$id");
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td>
                                <a href="images/<?php echo $data['gambar_berita'];?>" target="_blank">
                                <img src="images/<?php echo $data['gambar_berita'];?>" alt="gambar" width="200"></a><br>
                        ...
                        <tr>
                            <td width="100">Deskripsi Pendek Berita</td>
                            <td width="1">:</td>
                            <td><input value="<?php echo $data['short_desk'];?>" type="text" name="short_desk" class="form-control"></td>
                        </tr>
                        <tr>
