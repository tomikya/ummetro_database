        ...
        if($check !== false) {
            ...
            if(in_array($imageFileType, $allowed_types)) {
                ...
                if(move_uploaded_file($image['tmp_name'], $target_file)) {
                    ...
                    $query = $konek->prepare("INSERT INTO berita(tanggal_berita,short_desk, deskripsi_berita, gambar_berita) VALUES (?, ?, ?, ?)");
                    $query->bind_param("ssss", $tnggl, $shrt_desk, $desk, $nama_gambar);
                ...
                <form method="post" enctype="multipart/form-data">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td><input type="text" name="short_desk" class="form-control"></td>
                        </tr>
                        <tr>
