...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href="?page=tambahh_berita" class="btn btn-primary">+ Tambah Data</a><hr>
                <table class="table">
                    <tr>
                        <th>Nomor</th>
                        <th>Gambar</th>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><img width="200px" src="images/<?php echo $data['gambar_berita'];?>" alt="image"></td>
                            <td><?php echo $data['tanggal_berita']; ?></td>
                            <td><?php echo $data['short_desk'];?></td>
